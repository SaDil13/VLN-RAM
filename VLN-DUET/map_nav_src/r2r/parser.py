...
def parse_args():
    ...
    parser.add_argument('--train_aug_ft_file', type=str, default='default')
    parser.add_argument("--aug_train", default=None, help='aug as train')
...
def postprocess_args(args):
    ...
    ft_file_map = {
        ...
        'clip_b16': 'plus1kdims_CLIP-ViT-B-16-views.hdf5',
        'clip_l14': 'plus1kdims_CLIP-ViT-L-14-views.hdf5'
    }
